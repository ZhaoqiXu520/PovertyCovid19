...
```{r}
PovertyLogit <- glm(caserate ~ poverty_stage , data=poverty, family="binomial")
summary(PovertyLogit)

OR_cat<-exp(cbind(OR = coef(PovertyLogit), confint(PovertyLogit))) #calculate ORs and 95% CIs
OR_cat #print ORs and 95% CIs
